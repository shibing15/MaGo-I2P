...
def model_inference(model,data,args):
    ...
    # circle_loss,dists = desc_loss(img_features_flatten_inline, pc_features_inline, correspondence_mask,pos_margin=args.pos_margin,neg_margin=args.neg_margin)
    #根据相关系数计算loss2
    ...
    # model_result_for_loss_cal={'insider_num': insider_num,
    #                             'B': B, 'N': N, 'L': L,
...
if __name__=='__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/media/ai-i-sunyunda/data/data/KITTI_for_DEEPI2P', metavar='data_path', help='train and test data path')
    ...
    opt=options.Options()
    model=MAI2P(opt)
    checkpoints = torch.load('/home/ai-i-sunyunda/code/ei2p/runs/kitti/kitti_pc_cla_norm_voxel_cir_nosiamese_vfc_40960_256/dist_thres_1.00_pos_margin_0.20_neg_margin_1.80/mode_epoch_24.t7')
