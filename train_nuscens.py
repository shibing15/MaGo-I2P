...
from model.network import EI2P,SiamI2P
...
from model.loss import  det_loss2, siam_loss, siam_loss2, neg_siam_loss2, desc_loss
import numpy as np
import datetime
import logging
import math
...
if __name__=='__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/media/ai-i-sunyunda/data_2/nuscences/nuscenes2/', metavar='data_path',
    ...
    parser.add_argument('--save_path', type=str, default='./runs/nuscenes_log_xy_20480_128', metavar='save_path',
    ...
    for epoch in range(args.epoch):
        ...
        for step,data in enumerate(trainloader):
            ...
            siamese_loss = siam_loss(img_features_flatten_inline, pc_features_inline, correspondence_mask, 2.0)
            ...
            # loss =  neg_siam_loss  + siamese_loss  + loss_det * 0.5
            loss = siamese_loss * 2  + loss_det * 0.5
            #loss=loss_desc
            loss.backward()
            optimizer.step()
