...
class ImageEncoder(nn.Module):
    def __init__(self):
        ...
        self.backbone = resnet34(in_channels=4, pretrained=False, progress=True)
    ...
    def forward(self, x):
        ...
        img_global_feature=resnet_out[-1]  #512
        img_s32_feature_map=resnet_out[-2] #512
        img_s16_feature_map=resnet_out[-3] #256
        img_s8_feature_map=resnet_out[-4]  #128
        img_s4_feature_map=resnet_out[-5]  #64
        img_s2_feature_map=resnet_out[-6]  #64
